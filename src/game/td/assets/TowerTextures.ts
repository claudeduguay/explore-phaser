...
export const PLATFORM_CONFIG: Record<IDeliveryType, ITextureConfig<IPlatformOptions>> = {
  ...
  Vortex: typeAndCorners("ntagon", "angle", { divisions: 10 }),
  Fall: typeAndCorners("ntagon", "angle", { divisions: 12 }),
  Rise: typeAndCorners("ntagon", "angle", { divisions: 12 }),
  Pull: typeAndCorners("ntagon", "angle", { divisions: 12 }),
  Push: typeAndCorners("ntagon", "angle", { divisions: 12 }),
  Pulse: typeAndCorners("ntagon", "angle", { divisions: 30 }),
  Sweep: typeAndCorners("ntagon", "angle", { divisions: 30 }),
...
export const WEAPON_CONFIG: Record<IDeliveryType, ITextureConfig<IWeaponOptions>> = {
  ...
  Vortex: rectInsideWeapon(undefined, false),
  Fall: funnelInsideWeapon(),
  Rise: funnelInsideWeapon(),
  Pull: funnelInsideWeapon(),
  Push: funnelInsideWeapon(),
  Pulse: funnelInsideWeapon(undefined, false),
  Sweep: funnelInsideWeapon(undefined, false),
